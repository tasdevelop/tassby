...
//                //BUKA FORM MAIN ACTIVITY
                ...
                {
                    //BUKA FORM MAIN ACTIVITY
                    Intent myIntent = new Intent(ListTrip.this,MainMenuMandor.class);
                    myIntent.putExtra("user",nUser.toString());
                    startActivity(myIntent);
                    //BUKA FORM MAIN ACTIVITY
                }
                ...
                {
                    //BUKA FORM MAIN ACTIVITY
                    Intent myIntent = new Intent(ListTrip.this,MainMenuNonMandor.class);
                    myIntent.putExtra("user",nUser.toString());
                    startActivity(myIntent);
                    //BUKA FORM MAIN ACTIVITY
                }
...
//                    Toast.makeText(getApplicationContext(), Slecteditem, Toast.LENGTH_SHORT).show();
                    ...
                    //BUKA FORM MAIN ACTIVITY
                    Intent myIntent = new Intent(ListTrip.this,DetailTrip.class);

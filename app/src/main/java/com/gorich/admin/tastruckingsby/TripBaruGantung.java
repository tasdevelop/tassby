...
public class TripBaruGantung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trip_baru_gantung);
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcomboemklgantung";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcombojenisorderangantung";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcombotujuantarifgantung";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcombokotastdgantung";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
...
//            });
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcomboshippergantung";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcomboukurancontgantung";
            c.join();
            c.start();
            while (rslt == "START") {
                try {

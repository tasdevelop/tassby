...
public class ActivityTripBaruGantungSenin extends AppCompatActivity {
    ...
    protected AutoCompleteTextView mSupir;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trip_baru_gantung_senin);
        ...
        mSupir = (AutoCompleteTextView) findViewById((R.id.spinnerSupir));
        ...
        CharSequence s  = DateFormat.format("d MMMM yyyy ", cd.getTime());
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcomboemklgantungsenin";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcombojenisorderangantungsenin";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcombotujuantarifgantungsenin";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcombonopolonlysenin";
            c.user =nUser;
            c.join();
            c.start();
            while (rslt == "START") {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcombosupirtripsenin";
            c.user =nUser;
            c.join();
            c.start();
            while (rslt == "START") {
            ...
            mSupir.setOnTouchListener(new View.OnTouchListener(){
                @Override
                public boolean onTouch(View v, MotionEvent event){
                    mSupir.showDropDown();
                    return false;
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcombokotastdgantungsenin";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
...
//            });
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcomboshippergantungsenin";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getcomboukurancontgantungsenin";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
        ...
        bt_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try
                {
                    ...
                    c.status= "START";
                    c.sCommand ="entrytripgantungsenin";
                    c.join();
                    c.start( );
                    while(rslt=="START")
                    {
...
//                //BUKA FORM MAIN ACTIVITY
                ...
                {
                    //BUKA FORM MAIN ACTIVITY
                    Intent myIntent = new Intent(ActivityTripBaruGantungSenin.this,MainMenuMandor.class);
                    myIntent.putExtra("user",nUser.toString());
                    startActivity(myIntent);
                    //BUKA FORM MAIN ACTIVITY
                }
                ...
                {
                    //BUKA FORM MAIN ACTIVITY
                    Intent myIntent = new Intent(ActivityTripBaruGantungSenin.this,MainMenuNonMandor.class);
                    myIntent.putExtra("user",nUser.toString());
                    startActivity(myIntent);
                    //BUKA FORM MAIN ACTIVITY
                }
                ...
                {
                    //BUKA FORM MAIN ACTIVITY
                    Intent myIntent = new Intent(ActivityTripBaruGantungSenin.this,MainMenu.class);
                    myIntent.putExtra("user",nUser.toString());
                    startActivity(myIntent);
                    //BUKA FORM MAIN ACTIVITY
                }

...
public class AbsensiBaru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_absensi_baru);
        ...
        bt_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (("1".equals(nMandor.toString())))
                {
                    ...
                    Intent myIntent = new Intent(AbsensiBaru.this,MainMenuMandor.class);
                ...
                {
                    //BUKA FORM MAIN ACTIVITY
                    Intent myIntent = new Intent(AbsensiBaru.this,MainMenuNonMandor.class);
                    myIntent.putExtra("user",nUser.toString());
                    startActivity(myIntent);
                    //BUKA FORM MAIN ACTIVITY
                }
                ...
                {
                    //BUKA FORM MAIN ACTIVITY
                    Intent myIntent = new Intent(AbsensiBaru.this,MainMenu.class);
                    myIntent.putExtra("user",nUser.toString());
                    startActivity(myIntent);
                    //BUKA FORM MAIN ACTIVITY
                }
    ...
    {  // After a pause OR at startup
        ...
        try {
            rslt = "START";
            Caller c = new Caller();
            c.sCommand = "getlistabsensitoday";
            c.join();
            c.start();
            while (rslt == "START") {
                try {
...
//                    Toast.makeText(getApplicationContext(), Slecteditem, Toast.LENGTH_SHORT).show();
                    ...
                    myIntent.putExtra("jam",postsabsensi.get(position).getjam().toString());

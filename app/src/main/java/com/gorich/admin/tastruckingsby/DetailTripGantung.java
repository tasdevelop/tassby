...
public class DetailTripGantung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_trip_gantung);
        //TAMPIL ICON
...
//                    alert.show();
                    ...
                    {
                        //BUKA FORM MAIN ACTIVITY
                        Intent myIntent = new Intent(DetailTripGantung.this,ListTripGantung.class);
                        myIntent.putExtra("user",mUser.toString());
